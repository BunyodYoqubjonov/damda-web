...
import cls from './dachaCreateArea.module.scss'
...
export default function DachaCreateArea({
  residenceId,
  areaList,
  setAreaList,
  data,
  ...
  function fetchAreaTypes() {
    residenceService.getAreaTypes({ perPage: 1000, lang: locale }).then((res) => {
  ...
  function fetchResidenceAreas() {
    setLoading(true)
    residenceService
      .areaList(residenceId, {lang: locale})
