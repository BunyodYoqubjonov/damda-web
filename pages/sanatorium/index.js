...
export default function Sanatoriums({ data, error }) {
  ...
  const metaTitle = meta[locale].title_sanatorium
  const metaDescription = meta[locale].description_sanatorium
  ...
  return (
    <div style={{ minHeight: '50vh' }}>
      ...
      <Breadcrumbs
        ...
        current={navigation[locale].sanatorium}
      />
      <HotelsHeader
        title={metaTitle}
