...
export default function Hotels({ data, error }) {
  ...
  const metaTitle = meta[locale].title_hotel
  const metaDescription = meta[locale].description_hotel
  ...
  return (
    <div style={{ minHeight: '50vh' }}>
      ...
      <Breadcrumbs
        ...
        current={navigation[locale].hotels}
      />
      <HotelsHeader
        title={metaTitle}
